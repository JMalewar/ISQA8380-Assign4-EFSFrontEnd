            ...
            >
                    <template v-slot:item="props">
                      <tr>
                        ...
                        <td nowrap="true" align="left">{{ props.item.fund_description }}</td>
                    ...
                    >
                      <v-card>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          <v-list-item>
                            <v-list-item-content class="align-end">{{ item.fund_description }}</v-list-item-content>
                          </v-list-item>
                          <v-list-item>
                            <v-list-item-content>Fund:</v-list-item-content>
