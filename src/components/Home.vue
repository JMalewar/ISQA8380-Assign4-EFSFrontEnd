            ...
            >
              <v-row>
                ...
                <v-col>
                  <v-card>
                    <v-img
                      :src="require('@/assets/images/fund.jpg')" height="200px">
                    </v-img>
                    <v-card-text>
                      <div class="blue--text text-h6">
                        Funds
                ...
                <v-col>
                  <v-card>
                    <v-img
                      :src="require('@/assets/images/user.jpg')" height="200px">
                    </v-img>
                    <v-card-text>
                      <div class="blue--text text-h6">
                        Add User
                    ...
                    <v-card-actions>
                      <v-btn flat color="orange" @click="viewUsers">View Details</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-col>
              </v-row>
